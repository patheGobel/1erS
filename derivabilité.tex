...
$Df=\mathbb{R}$. Car f est une fonction polynômiale.
...
$Df=\mathbb{R}\setminus\left\lbrace 3\right\rbrace $. 

$g$ est dérivable sur $Df=\mathbb{R}\setminus\left\lbrace 3\right\rbrace $ et on a:
...
Donc $\forall x \in Df=\mathbb{R}\setminus\left\lbrace 3\right\rbrace$, $g'(x)<0$ donc $g$ est décroissante.

\textcolor{red}{Limites aux bornes de $D_{f}$}

Les bornes de $D_{f}$ sont $+\infty$, 3 et $-\infty$
...
[Tableau de variation]
\subsection*{\underline{\textbf{\textcolor{red}{III.Théorèmes}}}}
\subsection*{\underline{\textbf{\textcolor{red}{1)Théorème(théorème de la bijection)}}}}
\end{document}